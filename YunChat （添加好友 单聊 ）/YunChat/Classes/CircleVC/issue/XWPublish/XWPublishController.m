...
#import "ShowPushViewController.h"
...
//    self.navigationController.navigationBar.translucent = NO;
   ...
   self.tabBarController.navigationItem.title =  @"发布动态";
...
- (void)updateViewsFrame{
    ...
    _noteTextView.layer.borderWidth = 0.4;
...
//        ShowPushViewController *showPushVC  = [[ShowPushViewController alloc]init];
//        [self.navigationController pushViewController:showPushVC animated:YES];
    }];
    [alertController addAction:actionCacel];
    [self presentViewController:alertController animated:YES completion:nil];
}
