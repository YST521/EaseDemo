...
//  YunChat
//
//  Created by youxin on 2017/9/14.
//  Copyright © 2017年 mushoom. All rights reserved.
//

#import "CircleViewController.h"
#import "XWPublishController.h" //发布朋友圈
...
@interface CircleViewController () <SDTimeLineCellDelegate, UITextFieldDelegate>
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    UIBarButtonItem *rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"日间" style:UIBarButtonItemStyleDone target:self action:@selector(rightBarItemAction:)];
    ...
    UIBarButtonItem *rightBarButtonItemt =[[UIBarButtonItem alloc]initWithTitle:@"+" style:(UIBarButtonItemStylePlain) target:self action:@selector(addDynamic)];
    self.tabBarController.navigationItem.rightBarButtonItems =@[rightBarButtonItem,rightBarButtonItemt];
...
//    UIBarButtonItem *rightBarButtonItemt =[[UIBarButtonItem alloc]initWithTitle:@"+" style:(UIBarButtonItemStylePlain) target:self action:@selector(addDynamic)];
//     self.tabBarController.navigationItem.rightBarButtonItems =@[rightBarButtonItem,rightBarButtonItemt];
    //  self.navigationItem.rightBarButtonItem = rightBarButtonItemt;
//    self.tabBarController.navigationItem.rightBarButtonItem =rightBarButtonItemt;
    ...
    //[headerView.btn addTarget:self action:@selector(addDynamic) forControlEvents:(UIControlEventTouchUpInside)];
...
//    FamilyViewController *famVC =[[FamilyViewController alloc]init];
//    [self.navigationController pushViewController:famVC animated:YES];
    XWPublishController *pushVC =[[XWPublishController alloc]init];
