...
- (void)setupViews
{
    ...
    //评论对话框 !!!
    //UIImage *bgImage = [[[UIImage imageNamed:@"LikeCmtBg.png"] stretchableImageWithLeftCapWidth:40 topCapHeight:30] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
        UIImage *bgImage = [[[UIImage imageNamed:@"LikeCmtBg.png"] stretchableImageWithLeftCapWidth:40 topCapHeight:30] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
