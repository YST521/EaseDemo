...
// git    https://github.com/liangjiaxin/YunChat
    ...
    [[EaseMob sharedInstance] registerSDKWithAppKey:@"yst521#ease" apnsCertName:@"chatdemoui"];
    ...
    if([[NSUserDefaults standardUserDefaults] objectForKey:@"ISLOGIN"]){
        ...
        _tabbar.viewControllers = @[YunChat,chatList,circleVC,individual];
