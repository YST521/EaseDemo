...
- (void)viewDidLoad {
    ...
    //添加数据
    num = 4;
    arySelImage = [[NSArray alloc] initWithObjects:@"iconfont-xiaoxi",@"iconfont-haoyou-1",@"iconfont-haoyou-1",@"iconfont-my", nil];
    aryImage = [[NSArray alloc] initWithObjects:@"iconfont-iconfontxiaoxiweixuanzhong",@"iconfont-wodehaoyou-2",@"iconfont-wodehaoyou-2",@"iconfont-gerenzhongxin-5", nil];
